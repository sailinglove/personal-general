...
begin
  ...
  if lineThick = 1 then  //chessboard generation of thickness of 1
    begin
      for h := size downto 1 do  (*generate the suitable 'height' of the
                                         chessboard*)
        begin
          for w := size downto 1 do  //
            write('+---');                 //
          writeln('+');                    //(*generate suitable 'width' of the
          for w := size downto 1 do  //  chessboard*)
            write('|   ');                 //
          writeln('|');                    //

        end;
      for w := size downto 1 do  //(*complete the generation of the
            write('+---');             //  chessboard*)
          writeln('+');                //
    end
