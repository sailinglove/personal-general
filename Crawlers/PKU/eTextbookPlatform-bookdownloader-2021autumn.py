...
base_url = r"http://dangzheng.lib.pku.edu.cn/Service/?logic=PDFReaderController&call=readPDF&bookid=B_1957_000169"
...
pages = int(WebDriverWait(driver, 10).until(lambda d: d.find_element_by_id("pageinfo").text.strip("共").strip("页")))

for page in range(pages):
    page_img_src = WebDriverWait(driver, 10).until(lambda d: d.find_element_by_id("pdfimg")).get_attribute("src")
    print(page_img_src)
