...
//                       );
    ...
    or O1(S0D, S0DOR[0], S0DOR[1], S0DOR[2]);
    or O2(S1D, S1DOR[0], S1DOR[1], S1DOR[3]);
...
//                              );
    ...
    and A1(S0DOR[0], S0_L, S1, D_L, cntSD);
    and A2(S0DOR[1], S0, S1);
    and A3(S0DOR[2], S0, S1_L, D_L);
    
    and A4(S1DOR[0], S0_L, S1_L, D_L);
    and A5(S1DOR[1], S0_L, S1, D_L);
    and A6(S1DOR[2], S0, S1, cntT_L);
    
    and A7(BaudEN, S0_L, S1, D_L, cntSD);
    and A8(RegEN, S0, S1, cntT_L);
